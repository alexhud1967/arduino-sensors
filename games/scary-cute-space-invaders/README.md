...
To enable audio, create sound files in the `sounds/` folder:
...
1. **Open** `scary-cute-space-invaders.html` in any modern web browser
2. **Add your sound files** to the `sounds/` folder (optional)
3. **Move** your cute triangle ship with the mouse
4. **Shoot** automatically (always firing!)
5. **Hold LMB** for optional shooting sound effects
6. **Collect** powerups for extra lives and cannons
7. **Survive** the adorably terrifying enemy waves!
...
Open `scary-cute-space-invaders.html` and prepare for the most adorably terrifying space battle of your life! 
